    ...
    <section id="hero" className="w-full bg-background">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          {/* Right: Visual (replace with your existing hero image) */}
          <div className="relative w-full h-64 sm:h-80 md:h-[22rem] lg:h-[26rem] rounded-xl bg-ink border border-ink-secondary flex items-center justify-center">
            <span className="text-macho-orange/80 text-2xl md:text-3xl">$MACHO</span>
          </div>
        </div>
      </div>
    </section>
