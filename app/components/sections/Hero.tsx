      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-lg text-gray-300 max-w-xl mx-auto md:mx-0">
            Forget the barks, it's time for the bite. $MACHO is the apex predator of meme coins, delivering knockout blows to the competition.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            <BuyButton variant="primary" size="large" />
            <a href="#about" className="px-8 py-4 text-lg font-bold uppercase tracking-wider rounded-md border-2 border-macho-orange text-macho-orange transition-all duration-200 hover:bg-macho-orange hover:text-ink">
              Learn More
            </a>
          </div>
          <ContractAddress />
